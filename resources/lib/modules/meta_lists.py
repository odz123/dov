...
meta_colors = (
	...
	'burlywood', 'darkgoldenrod', 'ghostwhite', 'azure', 'lightslategray', 'lightsteelblue',
	...
	'limegreen', 'darkseagreen', 'forestgreen', 'green', 'darkgreen', 'darkolivegreen', 'olive', 'olivedrab',
