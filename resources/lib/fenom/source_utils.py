...
# Frozensets for O(1) membership testing in hot-path quality detection
RES_4K = frozenset(('2160', '216o', '.4k', 'ultrahd', 'ultra.hd', '.uhd.'))
RES_1080 = frozenset(('1080', '1o8o', '108o', '1o80', '.fhd.'))
RES_720 = frozenset(('720', '72o'))
SCR = frozenset(('dvdscr', 'screener', '.scr.', '.r5', '.r6'))
CAM = frozenset(('1xbet', 'betwin', '.cam.', 'camrip', 'cam.rip', 'dvdcam', 'dvd.cam', 'dvdts', 'hdcam', '.hd.cam', '.hctc', '.hc.tc', '.hdtc',
				'.hd.tc', 'hdts', '.hd.ts', 'hqcam', '.hg.cam', '.ts.', '.tc.', 'tsrip', 'telecine', 'telesync', 'tele.sync'))

LANG = frozenset(('arabic', 'bgaudio', 'castellano', 'chinese', 'dutch', 'finnish', 'french', 'german', 'greek', 'hebrew', 'italian', 'korean', 'latino', 'polish',
				'portuguese', 'russian', 'spanish', 'tamil', 'telugu', 'truefrench', 'truespanish', 'turkish'))
ABV_LANG = frozenset(('.ara.', '.ces.', '.chi.', '.chs.', '.cze.', '.dan.', '.de.', '.deu.', '.dut.', '.ell.', '.es.', '.esl.', '.esp.', '.fi.', '.fin.', '.fr.', '.fra.', '.fre.', '.frn.', '.gai.', '.ger.', '.gle.', '.gre.',
...
DUBBED = frozenset(('bengali.dub', 'dublado', 'dubbed', 'pldub'))
SUBS = frozenset(('subita', 'subfrench', 'subspanish', 'subtitula', 'swesub', 'nl.subs'))

ENG_CHECK = frozenset(('.eng.', '.en.', 'english', 'multi'))
SRT_CHECK = frozenset(('with.srt', '.avi', '.mkv', '.mp4'))

UNDESIRABLES = frozenset(('400p.octopus', '720p.octopus', '1080p.octopus', 'alexfilm', 'amedia', 'audiobook', 'baibako', 'bigsinema', 'bonus.disc', 'casstudio.tv', 'courage.bambey',
